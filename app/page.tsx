...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-cyan-50/50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col justify-between selection:bg-indigo-500 selection:text-white transition-colors">
      
      {/* HEADER / TOPO */}
      <header className="max-w-6xl w-full mx-auto px-6 py-6 flex items-center justify-between border-b border-cyan-100 dark:border-slate-900/50 backdrop-blur-md sticky top-0 z-50 bg-white/90 dark:bg-slate-950/85 transition-colors">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={toggleTheme}
            className="p-2.5 rounded-xl bg-cyan-100/70 dark:bg-slate-900 text-slate-800 dark:text-slate-200 hover:bg-cyan-200 dark:hover:bg-slate-700 transition border border-cyan-200 dark:border-slate-800 shadow-sm"
      ...
      <main className="max-w-5xl w-full mx-auto px-6 py-16 text-center space-y-12">
        ...
        <div className="inline-flex items-center gap-2 bg-emerald-100 dark:bg-indigo-950/85 border border-emerald-200 dark:border-indigo-800/60 text-emerald-800 dark:text-indigo-400 text-xs font-semibold px-4 py-1.5 rounded-full shadow-inner">
        ...
        <h1 className="text-4xl sm:text-7xl font-black text-slate-900 dark:text-white tracking-tight leading-[1.1]">
          O pior pesadelo de todo tutor é ver o seu melhor amigo <span className="text-cyan-700 dark:text-indigo-500 underline decoration-cyan-400/40">perdido na rua.</span>
        </h1>
        ...
        {/* ========================================== */}
        <div className="pt-8 pb-6 border-y border-cyan-100 dark:border-slate-900 my-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
            ...
            <div className="bg-white dark:bg-slate-900/80 border border-cyan-100 dark:border-slate-800 p-6 rounded-2xl space-y-3 relative overflow-hidden group hover:border-cyan-500/50 shadow-sm transition">
              <div className="text-3xl font-black text-cyan-600/10 dark:text-indigo-500/20 absolute top-4 right-4">01</div>
            ...
            <div className="bg-white dark:bg-slate-900/80 border border-cyan-100 dark:border-slate-800 p-6 rounded-2xl space-y-3 relative overflow-hidden group hover:border-cyan-500/50 shadow-sm transition">
              <div className="text-3xl font-black text-cyan-600/10 dark:text-indigo-500/20 absolute top-4 right-4">02</div>
            ...
            <div className="bg-white dark:bg-slate-900/80 border border-cyan-100 dark:border-slate-800 p-6 rounded-2xl space-y-3 relative overflow-hidden group hover:border-cyan-500/50 shadow-sm transition">
              <div className="text-3xl font-black text-cyan-600/10 dark:text-indigo-500/20 absolute top-4 right-4">03</div>
              <div className="text-2xl">📍</div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-4 max-w-3xl mx-auto text-center">
          ...
          <div className="bg-white dark:bg-slate-900/50 border border-cyan-100 dark:border-slate-900 p-4 rounded-xl shadow-sm">
          ...
          <div className="col-span-2 sm:col-span-1 bg-white dark:bg-slate-900/50 border border-cyan-100 dark:border-slate-900 p-4 rounded-xl shadow-sm">
            <p className="text-2xl sm:text-3xl font-extrabold text-cyan-700 dark:text-indigo-400">Paz Mental</p>
        ...
        <div className="pt-10 pb-8">
          <div className="bg-gradient-to-r from-cyan-900 via-teal-900 to-cyan-950 dark:from-indigo-950 dark:via-slate-900 dark:to-indigo-950 border border-cyan-700/50 dark:border-indigo-800/50 p-8 sm:p-12 rounded-3xl space-y-6 shadow-2xl text-white">
            <h2 className="text-2xl sm:text-4xl font-extrabold text-white">
              Não espere o susto acontecer para se prevenir.
            </h2>
            <p className="text-cyan-100 dark:text-slate-300 text-sm sm:text-base max-w-xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              ...
              <Link 
                href="/login" 
                className="w-full sm:w-auto bg-slate-900/80 hover:bg-slate-900 dark:bg-slate-900 dark:hover:bg-slate-800 text-white dark:text-slate-300 border border-cyan-700/50 dark:border-slate-800 font-semibold text-base px-8 py-4 rounded-2xl transition"
              >
                Acessar Minha Conta
              </Link>
            </div>
      ...
      {/* RODAPÉ */}
      <footer className="max-w-6xl w-full mx-auto px-6 py-8 border-t border-cyan-100 dark:border-slate-900 text-center text-xs text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-4 transition-colors">
